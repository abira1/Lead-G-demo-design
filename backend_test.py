...
BACKEND_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://nav-dropdown-fix-1.preview.emergentagent.com')
    ...
    def test_cors_headers(self):
        ...
        try:
            ...
            response = requests.options(
                f"{API_BASE_URL}/status",
                headers={
                    'Origin': 'https://nav-dropdown-fix-1.preview.emergentagent.com',
